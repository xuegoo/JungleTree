...
import network.codec.status.ServerListPingResponseObject.SLVersion;
import network.message.status.StatusRequestMessage;
import network.message.status.StatusResponseMessage;

import java.util.Collections;

import static network.codec.status.ServerListPingResponseObject.SLDescription;
import static network.codec.status.ServerListPingResponseObject.SLPlayers;
