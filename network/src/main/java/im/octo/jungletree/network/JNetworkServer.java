...
import im.octo.jungletree.rainforest.network.NetworkServer;
...
public class JNetworkServer implements NetworkServer, ConnectionManager {
    ...
    /*
        NetworkResponseProducerTask producer = new NetworkResponseProducerTask();
        new Thread(producer).start();

        NetworkRequestConsumerTask consumer = new NetworkRequestConsumerTask();
